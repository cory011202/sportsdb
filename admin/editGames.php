...
?>
<div id="wrapper">
    <div id="title">Choose game to update stats.</div>
...
while($row = mysql_fetch_array($result)){
    ...
    $resulth = mysql_query($getHomeTeamName)
              or die(mysql_errno());
    $homeTeamName = mysql_fetch_array($resulth);
?>
...
?>
<tr>
    <td colspan="7"><INPUT type="submit" value="Update Stats" name="submit" /><INPUT type="reset" value="Clear" name="c" /></td>
</tr>
</tr>
</table>
</div>
