...
?>
<div id="title">Choose game to add players.</div>
<div id="wrapper">
<?php
//get Left Column
...
<table id=""align="center" >
    <tr>
        <form method="POST" action="chooseBasketballPlayers.php">
            <td>
                <tr>
                    <?php
...
$getCurrentGames = "SELECT g.ID, g.gameDate, g.boys,g.tournament,a.teamID,h.teamID,
                    SUM(a.awayQ1 + a.awayQ2 + a.awayQ3 + a.awayQ3 + a.awayOt) as awaytotal,
...
?>
    <tr class="<?php echo $bgColor;?>">
        ...
        <td align="center"><?php echo $row['awaytotal'];?></td>
        <td><?php echo $homeTeamName[0];?></td>
        <td align="center"><?php echo $row['hometotal'];?></td>
    </tr>
