...
//Query to insert data into database
    $result = mysql_query("
      INSERT INTO
          bBallPlayerInfo(id, teamId, lName, fName, gradYear, boy )
      VALUES
          (NULL, '$teamID', '$lName', '$fName','$gradYear','$gender') 
        ")//End Query
      or die(mysql_error());  
...
echo "Click <a href=\"addBasketballPlayer.php\"><font color=\"red\" size=\"3px\">here</font></a> to add another Basketball player or Choose another action on from the left.";
