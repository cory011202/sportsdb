...
//Query to insert data into database
	$result = mysql_query("
	  INSERT INTO
		  volleyballPlayerInfo(id, teamID, lName, fName, gradYear)
	  VALUES
...
echo "Click <a href=\"addVolleyballPlayer.php\"><font color=\"red\" size=\"3px\">here</font></a> to add another Volleyball player or Choose another action on from the left.";
