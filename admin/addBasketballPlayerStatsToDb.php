...
foreach($_POST['aplayer'] as $key => $player){
	...
	$aturn_overs = $_POST['astat14'][$key];                        
			...
			$aInsertQuery = "                                                                                                                             
              ...
              VALUES
                  (NULL,'$gameID','$aTeamID','$aplayerID','$aConfID','$afg_made','$afg_attempts','$aft_made','$aft_attempts','$athree_made','$athree_attempts','$aoff_rebs',
                  '$adef_rebs','$ablocks','$aassists','$asteals','$afouls','$atech_fouls','$aturn_overs','$school_Yr')";
        //Execute the query
